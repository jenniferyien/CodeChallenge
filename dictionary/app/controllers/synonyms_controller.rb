class SynonymsController < ApplicationController
  ...
  def create
    ...
    #taking what was saved in params
    #if they are synonyms, they should equal the other way around
    @new_word = Word.find(@synonym.word_id).word
    @new_id = Word.find_by(word: @synonym.name).id
    #taking the synonyms and making a new one
    @commutative = Synonym.new(word_id: @new_id, name: @new_word)
    @commutative.save
  ...
  private
    ...
    def synonym_params
      params.require(:synonym).permit(:word_id, :name)
    end
end
